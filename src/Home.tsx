...
export const Home = () => {
    return (
        <div>
            ...
            <NewProduct />
            <About />
            <motion.img initial={{opacity:0,x:-100}} whileInView={{opacity:1,x:0,rotate:90,transition:{duration:1}}} src={deco2} alt=""
                        className="w-52  absolute rotate-90 -left-5 anime2"  />
            <Category />
